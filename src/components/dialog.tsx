...
export function DialogOverlay({
	...
	return (
		<DialogPrimitive.Overlay
			...
			className={cx(
				`
        fixed inset-0 z-50 bg-background-secondary/60 backdrop-blur-sm data-[state=open]:animate-in 
...
export function DialogFooter({
	...
	return (
		<div {...props}>
			...
			<footer className={cx("flex items-center justify-end gap-3", className)}>
				{children}
			</footer>
		</div>
	);
